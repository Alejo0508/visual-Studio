...
constraint aliasped2 primary key (id_pedido),
constraint aiaspedcli2 foreign key(id_cliente1) references cliente(id_cliente),
constraint aliaspedpro2 foreign key (id_producto1) references producto(id_producto))
...
@fecha_entrega varchar
as
insert into pedido(id_producto1,cantidad_producto,id_cliente1,total,fecha_creacion,fecha_entrega) values (@id_producto1,@cantidad_producto,@id_cliente1,@total,@fecha_creacion,@fecha_entrega)

create proc crear_pedido4
@id_producto1 int,
@cantidad_producto int,
@id_cliente1 int,
@total money,
...
as
insert into pedido2(id_producto1,cantidad_producto,id_cliente1,total,fecha_creacion,fecha_entrega) values (@id_producto1,@cantidad_producto,@id_cliente1,@total,@fecha_creacion,@fecha_entrega)


create proc eliminarpedido
@id_pedido int
as
delete from pedido2 where @id_pedido=id_pedido
...
@id_pedido int
as
select * from pedido2 where @id_pedido = id_pedido
