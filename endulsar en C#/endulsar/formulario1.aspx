        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="alert-success">
                    <asp:TextBox ID="tbTotal" runat="server" Width="255px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style6"></td>
                <td class="auto-style7">
                    <asp:Label ID="tbrespuesta" runat="server" ForeColor="White"></asp:Label>
                </td>
            </tr>
            <tr>
                ...
                <td class="auto-style5">
                    ...
                    <asp:Button ID="btnlimpiar" runat="server" BackColor="#009933" OnClick="btnlimpiar_Click" Text="Limpiar" style="margin-left: 50px;" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">&nbsp;</td>
